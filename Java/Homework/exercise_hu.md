...
Készíts egy `tv.Wallet` (*továbbiakban tárca*) osztály, amely az alkalmazáson belüli fizetést teszi lehetővé. Az tárca a [`tv.CreditCard`](https://github.com/abelkocsis/Teaching/blob/master/Java/Files/Test.java) osztállyal fog kommunikálni és pénzt kérni onnan, ha valamiért fizetnünk kell. Ez azért szükséges, hogy az alkalmazásnak ne kelljen közvetlenül bankkártyákat kezelnie, a fizetéshez elegendő legyen a csak tárcából "kivenni" a pénzt.
