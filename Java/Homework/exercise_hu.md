...
A feladat egy olyan JAVA program írása, amely bemutatja egy *TV app* nevű alkalmazás működését. A (részben) kész megoldásod a melléket `Test` [link](https://github.com/abelkocsis/Teaching/blob/master/Java/Files/Test.java) osztállyal ellenőrizheted. Részleges megoldás teszteléséhez, kommenteld ki a még nem kész programrészekre vonatkozó teszteket!
