...
A feladat egy olyan JAVA program írása, amely bemutatja egy *TV app* nevű alkalmazás működését. A (részben) kész megoldásod a melléket [`Test`](https://github.com/abelkocsis/Teaching/blob/master/Java/Files/Test.java) osztállyal ellenőrizheted. További szükséges osztály: [`Assertions`](https://github.com/abelkocsis/Teaching/blob/master/Java/Files/Assertions.java) Részleges megoldás teszteléséhez, kommenteld ki a még nem kész programrészekre vonatkozó teszteket!
